...
public class AuraURLFactory {
  ...
  public AuraConsole buildConsoleURI(String boltURI, boolean devMode)
      throws CommandFailedException {
    ConsoleUrlMatcher[] matchers =
        devMode
            ...
            : new ConsoleUrlMatcher[] {
              new ConsoleUrlMatcher.ProdMatcher(), new ConsoleUrlMatcher.PrivMatcher()
            };
  ...
  abstract static class ConsoleUrlMatcher {
    ...
    //   bolt+routing://rogue-mattias.databases.neo4j.io  -->
    // https://console-mattias.neo4j.io/v1/databases/rogue
