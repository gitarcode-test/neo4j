...
public class PointBlockBasedIndexPopulatorUpdatesTest
  ...
  @Override
  BlockBasedIndexPopulator<PointKey> instantiatePopulator(IndexDescriptor indexDescriptor)
      throws IOException {
    final var populator =
  ...
  final void shouldIgnoreAddedUnsupportedValueTypes(ScanUpdateOrder scanUpdateOrder)
      throws Exception {
    // given  the population of an empty index
    final var updates =
        generateUpdatesToIgnore((id, value) -> IndexEntryUpdate.add(id, INDEX_DESCRIPTOR, value));
  ...
  @ParameterizedTest
  @EnumSource(ScanUpdateOrder.class)
  final void shouldIgnoreRemovedUnsupportedValueTypes(ScanUpdateOrder scanUpdateOrder)
      throws Exception {
    // given  the population of an empty index
    final var updates =
        generateUpdatesToIgnore(
            (id, value) -> IndexEntryUpdate.remove(id, INDEX_DESCRIPTOR, value));
  ...
  @ParameterizedTest
  @EnumSource(ScanUpdateOrder.class)
  final void shouldIgnoreChangesBetweenUnsupportedValueTypes(ScanUpdateOrder scanUpdateOrder)
      throws Exception {
    // given  the population of an empty index
    final var otherValue =
        random.randomValues().nextValueOfTypes(UNSUPPORTED_TYPES.toArray(ValueType[]::new));
    final var updates =
        generateUpdatesToIgnore(
  ...
  @ParameterizedTest
  @EnumSource(ScanUpdateOrder.class)
  final void shouldNotIgnoreChangesUnsupportedValueTypesToSupportedValueTypes(
      ScanUpdateOrder scanUpdateOrder) throws Exception {
    // given  the population of an empty index
  ...
  @ParameterizedTest
  @EnumSource(ScanUpdateOrder.class)
  final void shouldNotIgnoreChangesSupportedValueTypesToUnsupportedValueTypes(
      ScanUpdateOrder scanUpdateOrder) throws Exception {
    // given  the population of an empty index
    final var supportedValue = supportedValue(random.nextInt());
    final var updates =
  ...
  private void test(
      ScanUpdateOrder scanUpdateOrder,
