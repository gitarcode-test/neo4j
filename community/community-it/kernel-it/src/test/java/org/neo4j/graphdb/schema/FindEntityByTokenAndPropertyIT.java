...
/**
 * Use @TestInstance( TestInstance.Lifecycle.PER_CLASS ) to not setup new dbms for every test.
 * Instead reuse same db and clean it between every round. This shortens test execution a lot!
 */
...
public class FindEntityByTokenAndPropertyIT {
  ...
  private static final String[] PROPERTY_KEYS =
      new String[] {PROPERTY_KEY, PROPERTY_KEY_2, PROPERTY_KEY_3};
  ...
  void shouldUseIndexWhenFindingEntityWithIndexCompatiblePropertyValue(
    ...
    IndexDescriptor[] expectedDescriptors =
        expectedDescriptors(firstDescriptor, firstIndex.supportedType(value));
    validateUsedExpectedIndex(
        "exact match single property: " + valueAsString(value), expectedDescriptors);
  }
  ...
  void shouldUseIndexWhenFindingEntityWithIndexCompatiblePropertyValueMultipleIndexes(
    ...
    try (Transaction tx = db.beginTx()) {
      firstDescriptor = entityCreator.createIndex(tx, firstIndex.indexType(), TOKEN, PROPERTY_KEY);
      secondDescriptor =
          entityCreator.createIndex(tx, secondIndex.indexType(), TOKEN, PROPERTY_KEY);
      tx.commit();
    }
    awaitIndexes();
    indexMonitor.clear();
    ...
    IndexDescriptor[] expectedDescriptors =
        expectedDescriptors(
            firstDescriptor,
            secondDescriptor,
            firstIndex.supportedType(value),
  ...
  void shouldUseIndexWhenFindingEntityWithIndexCompatiblePropertyValueCompositeQuery2(
    ...
    try (Transaction tx = db.beginTx()) {
      firstDescriptor =
          entityCreator.createIndex(
              tx, firstIndex.indexType(), TOKEN, PROPERTY_KEY, PROPERTY_KEY_2);
      tx.commit();
    }
    awaitIndexes();
    indexMonitor.clear();
    ...
    validateUsedExpectedIndex(
        "exact match composite property: " + compositeValueString(value1, value2),
        expectedDescriptors);
  }
  ...
  void shouldUseIndexWhenFindingEntityWithIndexCompatiblePropertyValueCompositeQuery2MultiIndex(
    ...
    try (Transaction tx = db.beginTx()) {
      ...
      secondDescriptor =
          entityCreator.createIndex(
              tx, secondIndex.indexType(), TOKEN, PROPERTY_KEY, PROPERTY_KEY_2);
      tx.commit();
    }
    awaitIndexes();
    indexMonitor.clear();
  ...
  void shouldUseIndexWhenFindingEntityWithIndexCompatiblePropertyValueCompositeQuery3(
    ...
    try (Transaction tx = db.beginTx()) {
      ...
      ResourceIterator<? extends Entity> result =
          findMethod.find(
              tx, TOKEN, PROPERTY_KEY, value1, PROPERTY_KEY_2, value2, PROPERTY_KEY_3, value3);
    ...
    validateUsedExpectedIndex(
        "exact match composite property: " + compositeValueString(value1, value2, value3),
        expectedDescriptors);
  }
  ...
  void shouldUseIndexWhenFindingEntityWithIndexCompatibleStringSearch(
    ...
    try (Transaction tx = db.beginTx()) {
      firstDescriptor =
          entityCreator.createIndex(tx, firstIndexType.indexType(), TOKEN, PROPERTY_KEY);
      tx.commit();
    }
    awaitIndexes();
    indexMonitor.clear();
    ...
    IndexDescriptor[] expectedDescriptors =
        expectedDescriptors(
            firstDescriptor, firstIndexType.supportedStringSearch(stringSearchMode));
    validateUsedExpectedIndex(
        "string search: "
            + stringSearchMode
            + " on template "
  ...
  private void validateUsedExpectedIndex(
      String queryDescription, IndexDescriptor... anyExpectedIndexDescriptor) {
  ...
  public static Stream<Arguments> indexCompatibilities() {
    ...
    for (SupportedIndexType index : SupportedIndexType.values()) {
      ...
      arguments.add(
          Arguments.of(EntityCreator.NODE, FindMethod.singleNodeFromExecutionContext, index));
      arguments.add(Arguments.of(EntityCreator.NODE, FindMethod.multipleNodes, index));
      arguments.add(
          Arguments.of(EntityCreator.NODE, FindMethod.multipleNodesFromExecutionContext, index));
      ...
      arguments.add(
          Arguments.of(
              ...
              index));
      arguments.add(
          Arguments.of(EntityCreator.RELATIONSHIP, FindMethod.multipleRelationships, index));
      arguments.add(
          Arguments.of(
              EntityCreator.RELATIONSHIP,
              ...
              index));
      arguments.add(
          Arguments.of(EntityCreator.RELATIONSHIP, FindMethod.multipleRelationshipsMap, index));
      arguments.add(
          Arguments.of(
              EntityCreator.RELATIONSHIP,
    ...
    for (SupportedIndexType firstIndex : SupportedIndexType.values()) {
      for (SupportedIndexType secondIndex : SupportedIndexType.values()) {
        if (firstIndex != secondIndex) {
          arguments.add(
              Arguments.of(EntityCreator.NODE, FindMethod.singleNode, firstIndex, secondIndex));
          arguments.add(
              Arguments.of(
                  EntityCreator.NODE,
                  FindMethod.singleNodeFromExecutionContext,
                  firstIndex,
                  secondIndex));
          arguments.add(
              Arguments.of(EntityCreator.NODE, FindMethod.multipleNodes, firstIndex, secondIndex));
          arguments.add(
              Arguments.of(
                  EntityCreator.NODE,
                  FindMethod.multipleNodesFromExecutionContext,
                  firstIndex,
                  secondIndex));
          arguments.add(
              Arguments.of(
          ...
          arguments.add(
              Arguments.of(
                  EntityCreator.RELATIONSHIP,
                  FindMethod.multipleRelationships,
                  firstIndex,
                  secondIndex));
          arguments.add(
              Arguments.of(
  ...
  public static Stream<Arguments> indexCompatibilitiesComposite2() {
    ...
    stream(SupportedIndexType.values())
        ...
        .forEach(
            index -> {
              arguments.add(
                  Arguments.of(EntityCreator.NODE, FindMethod.multipleNodesComposite2, index));
              arguments.add(
                  Arguments.of(
                      EntityCreator.NODE,
              ...
              arguments.add(
                  Arguments.of(
                      EntityCreator.NODE, FindMethod.multipleNodesFromExecutionContextMap, index));
              arguments.add(
                  Arguments.of(
                      EntityCreator.RELATIONSHIP,
              ...
              arguments.add(
                  Arguments.of(
                      EntityCreator.RELATIONSHIP, FindMethod.multipleRelationshipsMap, index));
              arguments.add(
                  Arguments.of(
                      EntityCreator.RELATIONSHIP,
                      FindMethod.multipleRelationshipsFromExecutionContextMap,
  ...
  public static Stream<Arguments> indexCompatibilitiesComposite3() {
    ...
    stream(SupportedIndexType.values())
        ...
        .forEach(
            index -> {
              arguments.add(
                  Arguments.of(EntityCreator.NODE, FindMethod.multipleNodesComposite3, index));
              arguments.add(
                  Arguments.of(
                      EntityCreator.NODE,
  ...
  private enum FindMethod {
    singleNode {
      ...
      ResourceIterator<? extends Entity> find(
        ...
        return Iterators.asResourceIterator(
            Collections.<Entity>singletonList(
                tx.findNode(Label.label(token), propertyKey, propertyValue)));
      }
    },
    singleNodeFromExecutionContext {
      ...
      ResourceIterator<? extends Entity> find(
        ...
        return Iterators.asResourceIterator(
            Collections.<Entity>singletonList(
                executionContextTransaction(tx)
                    .findNode(Label.label(token), propertyKey, propertyValue)));
      }
    },
    multipleNodes {
      @Override
    ...
    multipleNodesFromExecutionContext {
      ...
      ResourceIterator<? extends Entity> find(
        ...
        return executionContextTransaction(tx)
            .findNodes(Label.label(token), propertyKey, propertyValue);
      }
    },
    ...
    multipleNodesComposite2 {
      ...
      ResourceIterator<? extends Entity> find(
        ...
        return tx.findNodes(
            Label.label(token), propertyKey1, propertyValue1, propertyKey2, propertyValue2);
      }
    },
    ...
    stringSearchNodesFromExecutionContext {
      ...
      ResourceIterator<? extends Entity> find(
          ...
          StringSearchMode searchMode) {
        return executionContextTransaction(tx)
            .findNodes(Label.label(token), propertyKey, template, searchMode);
      }
    },
      ...
      ResourceIterator<? extends Entity> find(
        ...
        return Iterators.asResourceIterator(
            singletonList(
                executionContextTransaction(tx)
                    .findRelationship(
                        RelationshipType.withName(token), propertyKey, propertyValue)));
      }
    },
    ...
    multipleRelationshipsMap {
      ...
      ResourceIterator<? extends Entity> find(
          Transaction tx, String token, String propertyKey, Object propertyValue) {
        return tx.findRelationships(
            RelationshipType.withName(token), Map.of(propertyKey, propertyValue));
      }
    ...
    stringSearchRelationships {
      ...
      ResourceIterator<? extends Entity> find(
          ...
          StringSearchMode searchMode) {
        return tx.findRelationships(
            RelationshipType.withName(token), propertyKey, template, searchMode);
      }
    },
    ...
    ResourceIterator<? extends Entity> find(
      ...
      throw new UnsupportedOperationException(
          "This FindMethod does not support single property query");
    }
  ...
  private enum EntityCreator {
    NODE {
      ...
      @Override
      IndexDescriptor createIndex(
          Transaction tx, IndexType indexType, String token, String... propertyKeys) {
    ...
    RELATIONSHIP {
      ...
      Entity createEntity(Transaction tx, String token) {
        return tx.createNode()
            .createRelationshipTo(tx.createNode(), RelationshipType.withName(token));
      }
    ...
    abstract IndexDescriptor createIndex(
        Transaction tx, IndexType indexType, String token, String... propertyKeys);
  ...
  private enum SupportedIndexType {
    RANGE(
        ...
        // Suffix and contains not supported natively in the index but core API can use it and do
        // the filtering
        Predicates.alwaysTrue(),
        true),
    TEXT(
