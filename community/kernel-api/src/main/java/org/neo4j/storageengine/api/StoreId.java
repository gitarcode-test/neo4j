...
public class StoreId extends StoreVersionIdentifier {
  ...
  public static StoreId generateNew(
      String storageEngineName, String formatName, int majorVersion, int minorVersion) {
    return new StoreId(
  ...
  /**
   * Returns {@code true} if the submitted {@code anotherId} is an upgrade successor of this store
   * ID. This means that the IDs have all the same attributes, but possibly differ only in the minor
   * store version part and the minor store version of the submitted {@code anotherId} is greater
   * than or equal to the minor version of this store version.
   */
   ...
   *
   * <p>This method will return {@code null} if the layout points to an empty or uninitialised
   * store.
   */
