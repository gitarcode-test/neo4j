...
abstract class AbstractMetadataHandlerTest {
  ...
  void shouldApplyFieldNames() {
    ...
    ListValueAssertions.assertThat(captor.getValue())
        .containsExactly(
            Values.stringValue("firstName"),
            Values.stringValue("lastName"),
            Values.stringValue("age"));
  }
  ...
  private ExecutionPlanDescription prepareExecutionPlanDescription(
      TriConsumer<ExecutionPlanDescription, ExecutionPlanDescription, ExecutionPlanDescription>
          configurer) {
  ...
  void shouldApplyExecutionPlan() {
    this.handler.onExecutionPlan(
        consumer, this.prepareExecutionPlanDescription((root, child1, child2) -> {}));
    ...
    this.verifyExecutionPlanDescriptionMetadata(
        captor.getValue(),
        root ->
            MapValueAssertions.assertThat(root)
        ...
        child1 ->
            MapValueAssertions.assertThat(child1)
                .doesNotContainKey("dbHits")
                .doesNotContainKey("pageCacheHits")
                .doesNotContainKey("pageCacheMisses")
                .doesNotContainKey("pageCacheHitRatio")
                ...
                .doesNotContainKey("time"),
        child2 ->
            MapValueAssertions.assertThat(child2)
                .doesNotContainKey("dbHits")
                .doesNotContainKey("pageCacheHits")
                .doesNotContainKey("pageCacheMisses")
                .doesNotContainKey("pageCacheHitRatio")
  ...
  void shouldApplyExecutionPlanWhenProfilerInformationIsAvailable() {
    ...
    this.handler.onExecutionPlan(
        consumer,
        this.prepareExecutionPlanDescription(
            (root, child1, child2) -> {
