...
public class PackstreamBufWriteTest {
                    ...
                    () -> {
                      var ex =
                          assertThrows(
                              ...
                              () -> prepareBuffer(b -> b.writeMarker(marker)));
                ...
                dynamicTest(
                    ...
                    () -> {
                      var ex =
                          assertThrows(
                              IllegalArgumentException.class,
                              () -> prepareBuffer(b -> b.writeMarker(marker, 15)));
                ...
                dynamicTest(
                    ...
                    () -> {
                      ...
                      var ex =
                          assertThrows(
                              IllegalArgumentException.class,
                              () -> prepareBuffer(b -> b.writeMarker(marker, length)));

                      assertThat(ex)
                          .hasMessage(
                              "Type %s cannot store value of length %d (limit is %d)",
                              marker.name(), length, marker.getLengthPrefix().getMaxValue());
                    }));
  }
  ...
  void writeMarkerShouldFailWithIllegalArgumentWhenNoMarkersAreGiven() {
    var ex =
        assertThrows(
            IllegalArgumentException.class,
            () -> prepareBuffer(b -> b.writeMarker(Collections.emptyList(), 42)));
  ...
  void writeMarkerShouldFailWithIllegalArgumentWhenLengthPrefixExceedsMaximumOfAllAlternatives() {
    ...
    var maxLengths =
        TypeMarker.STRING_TYPES.stream()
            .map(
                marker ->
                    String.format("%d (%s)", marker.getLengthPrefix().getMaxValue(), marker.name()))
            ...
            value ->
                dynamicTest(
                    ...
                    () -> {
                      ...
                      assertThat(actual)
                          .isEqualTo((value ? TypeMarker.TRUE : TypeMarker.FALSE).getValue());
                      assertThat(buf.isReadable()).isFalse();
                    }));
  }
  ...
  Stream<DynamicTest> shouldWriteString() {
    return Stream.of(
            ...
            new MarkerExpectation<>(
                (int) LengthPrefix.NIBBLE.getMaxValue(), TypeMarker.TINY_STRING),
            new MarkerExpectation<>(
                (int) LengthPrefix.NIBBLE.getMaxValue() + 1, TypeMarker.STRING8),
            new MarkerExpectation<>((int) LengthPrefix.UINT8.getMaxValue(), TypeMarker.STRING8),
            new MarkerExpectation<>(
                (int) LengthPrefix.UINT8.getMaxValue() + 1, TypeMarker.STRING16),
            new MarkerExpectation<>((int) LengthPrefix.UINT16.getMaxValue(), TypeMarker.STRING16),
            new MarkerExpectation<>(
                (int) LengthPrefix.UINT16.getMaxValue() + 1, TypeMarker.STRING32))
        .map(
            expectation ->
                dynamicTest(
                    expectation.toString(),
  ...
  void writeStringShouldFailWithNullPointerWhenNullIsGiven() {
    var ex =
        assertThrows(NullPointerException.class, () -> prepareBuffer(b -> b.writeString(null)));
  ...
  Stream<DynamicTest> shouldWriteTinyString() {
    return IntStream.rangeClosed(0, (int) LengthPrefix.NIBBLE.getMaxValue())
        .mapToObj(
            size ->
                dynamicTest(
                    String.format("%d characters", size),
                    () -> {
  ...
  void writeTinyStringShouldFailWithNullPointerWhenNullIsGiven() {
    var ex =
        assertThrows(NullPointerException.class, () -> prepareBuffer(b -> b.writeTinyString(null)));
  ...
  void writeString8ShouldFailWithNullPointerWhenNullIsGiven() {
    var ex =
        assertThrows(NullPointerException.class, () -> prepareBuffer(b -> b.writeString8(null)));
  ...
  void writeString16ShouldFailWithNullPointerWhenNullIsGiven() {
    var ex =
        assertThrows(NullPointerException.class, () -> prepareBuffer(b -> b.writeString16(null)));
  ...
  void writeString32ShouldFailWithNullPointerWhenNullIsGiven() {
    var ex =
        assertThrows(NullPointerException.class, () -> prepareBuffer(b -> b.writeString32(null)));
  ...
  void writeListHeaderShouldFailWithIllegalArgumentWhenNegativeSizeIsGiven() {
    var ex =
        assertThrows(
            IllegalArgumentException.class, () -> prepareBuffer(b -> b.writeListHeader(-1)));
  ...
  void writeListShouldFailWithNullPointerWhenNullIsGiven() {
    ...
    var ex =
        assertThrows(
            NullPointerException.class, () -> prepareBuffer(b -> b.writeList(null, writer)));
  ...
  void writeTinyListShouldFailWithNullPointerWhenNullIsGiven() {
    ...
    var ex =
        assertThrows(
            NullPointerException.class, () -> prepareBuffer(b -> b.writeTinyList(null, writer)));
  ...
  void writeList8ShouldFailWithNullPointerWhenNullIsGiven() {
    ...
    var ex =
        assertThrows(
            NullPointerException.class, () -> prepareBuffer(b -> b.writeList8(null, writer)));
  ...
  void writeList16ShouldFailWithNullPointerWhenNullIsGiven() {
    ...
    var ex =
        assertThrows(
            NullPointerException.class, () -> prepareBuffer(b -> b.writeList16(null, writer)));
  ...
  void writeList32ShouldFailWithNullPointerWhenNullIsGiven() {
    ...
    var ex =
        assertThrows(
            NullPointerException.class, () -> prepareBuffer(b -> b.writeList32(null, writer)));
  ...
  Stream<DynamicTest> shouldWriteMap() {
    // Note: Tests for the maximum of MAP16 and minimum of MAP32 are omitted as they would generate
    // too much data
    // thus
            ...
            expectation ->
                dynamicTest(
                    ...
                    () -> {
                      var writer = mock(Writer.class);
                      var payload =
                          IntStream.rangeClosed(1, expectation.input())
  ...
  void writeMapShouldFailWithNullPointerWhenNullIsGiven() {
    ...
    var ex =
        assertThrows(
            NullPointerException.class, () -> prepareBuffer(b -> b.writeMap(null, writer)));
  ...
  void writeTinyMapShouldFailWithNullPointerWhenNullIsGiven() {
    ...
    var ex =
        assertThrows(
            NullPointerException.class, () -> prepareBuffer(b -> b.writeTinyMap(null, writer)));
  ...
  void writeMap8ShouldFailWithNullPointerWhenNullIsGiven() {
    ...
    var ex =
        assertThrows(
            NullPointerException.class, () -> prepareBuffer(b -> b.writeMap8(null, writer)));
  ...
  void writeMap16ShouldFailWithNullPointerWhenNullIsGiven() {
    ...
    var ex =
        assertThrows(
            NullPointerException.class, () -> prepareBuffer(b -> b.writeMap16(null, writer)));
  ...
  void writeMap32ShouldFailWithNullPointerWhenNullIsGiven() {
    ...
    var ex =
        assertThrows(
            NullPointerException.class, () -> prepareBuffer(b -> b.writeMap32(null, writer)));
  ...
  Stream<DynamicTest> shouldWriteStructHeader() {
    return IntStream.rangeClosed(0, (int) LengthPrefix.NIBBLE.getMaxValue())
        .mapToObj(
            fields ->
                dynamicTest(
                    String.format("%d fields", fields),
                    () -> {
                      var buf =
                          prepareBuffer(
                              b -> b.writeStructHeader(new StructHeader(fields, (short) 0x42)));
            ...
            fields ->
                dynamicTest(
                    ...
                    () -> {
                      ...
                      when(registry.getWriter(payload))
                          .thenReturn(Optional.<StructWriter<Object, Object>>of(writer));
  ...
  void writeStructShouldFailWithIllegalArgumentWhenRegistryReturnsEmptyOptional() {
    ...
    var ex =
        assertThrows(
            IllegalArgumentException.class,
            () -> prepareBuffer(b -> b.writeStruct(null, registry, payload)));
  ...
  void writeStructShouldFailWithNullPointerWhenRegistryIsNull() {
    ...
    var ex =
        assertThrows(
            ...
            () -> prepareBuffer(b -> b.writeStruct(null, null, payload)));
