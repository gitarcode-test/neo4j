...
class PackstreamBufReadTest {
    ...
    getVariations(actual)
        .forEach(
            variation -> {
              ...
              var ex =
                  assertThrows(UnexpectedTypeMarkerException.class, () -> consumer.accept(buf));
                                ...
                                valid -> {
                                  ...
                                  try {
                                    ...
                                    throw new AssertionError(
                                        String.format("Failed to decode variation 0x%02X", valid),
                                        ex);
                                  }
                                })));
  }
                            ...
                            .forEach(
                                invalid ->
                                    assertThrowsUnexpectedTypeMarker(
                                        expected,
                                        invalid,
                                        buf -> buf.readExpectedMarker(expected)))));
  }
                            ...
                            .forEach(
                                invalid ->
                                    assertThrowsUnexpectedType(
                                        expected,
                                        invalid,
                                        buf -> buf.readLengthPrefixMarker(expected, -1)))));
  }
                    ...
                    () -> {
                      ...
                      var ex =
                          assertThrows(
                              ...
                              () -> buf.readLengthPrefixMarker(marker.getType(), 42));
        ...
        .map(
            marker ->
                dynamicTest(
                    ...
                    () ->
                        assertThrowsUnexpectedTypeMarker(
                            TypeMarker.NULL, marker, PackstreamBuf::readNull)));
  }
        ...
        .map(
            marker ->
                dynamicTest(
                    ...
                    () ->
                        assertThrowsUnexpectedType(
                            Type.BOOLEAN, marker, PackstreamBuf::readBoolean)));
  }
  ...
  Stream<DynamicTest> readIntShouldAcceptTinyInt() {
    return IntStream.rangeClosed((int) Type.TINY_INT_MIN, (int) Type.TINY_INT_MAX)
        .mapToObj(
            expected ->
                dynamicTest(
                    String.format("0x%02X", (byte) expected),
                    () -> {
    ...
    return getValidMarkers(Type.INT)
        .map(
            marker ->
                dynamicTest(
                    marker.name(),
                    () -> assertThrowsUnexpectedType(Type.INT, marker, PackstreamBuf::readInt)));
  }
        ...
        .map(
            invalid ->
                dynamicTest(
                    ...
                    () ->
                        assertThrowsUnexpectedTypeMarker(
                            TypeMarker.INT8, invalid, PackstreamBuf::readInt8)));
  }
        ...
        .map(
            invalid ->
                dynamicTest(
                    ...
                    () ->
                        assertThrowsUnexpectedTypeMarker(
                            TypeMarker.INT16, invalid, PackstreamBuf::readInt16)));
  }
        ...
        .map(
            invalid ->
                dynamicTest(
                    ...
                    () ->
                        assertThrowsUnexpectedTypeMarker(
                            TypeMarker.INT32, invalid, PackstreamBuf::readInt32)));
  }
        ...
        .map(
            invalid ->
                dynamicTest(
                    ...
                    () ->
                        assertThrowsUnexpectedTypeMarker(
                            TypeMarker.INT64, invalid, PackstreamBuf::readInt64)));
  }
                ...
                dynamicTest(
                    ...
                    () -> {
                      var buf =
                          prepareBuffer(
                              b ->
                                  b.writeByte(TypeMarker.FLOAT64.getValue()).writeDouble(expected));
        ...
        .map(
            invalid ->
                dynamicTest(
                    ...
                    () ->
                        assertThrowsUnexpectedTypeMarker(
                            TypeMarker.FLOAT64, invalid, PackstreamBuf::readFloat)));
  }
                ...
                dynamicTest(
                    ...
                    () -> {
                      ...
                      var buf =
                          prepareBuffer(
                              b ->
                                  b.writeByte(TypeMarker.BYTES8.getValue())
                                      .writeByte(size)
                                      .writeBytes(payload));
                ...
                dynamicTest(
                    ...
                    () -> {
                      ...
                      var buf =
                          prepareBuffer(
                              b ->
                                  b.writeByte(TypeMarker.BYTES16.getValue())
                                      .writeShort(size)
                                      .writeBytes(payload));
                ...
                dynamicTest(
                    ...
                    () -> {
                      ...
                      var buf =
                          prepareBuffer(
                              b ->
                                  b.writeByte(TypeMarker.BYTES32.getValue())
                                      .writeInt(size)
                                      .writeBytes(payload));
        ...
        .map(
            invalid ->
                dynamicTest(
                    ...
                    () ->
                        assertThrowsUnexpectedTypeMarker(
                            TypeMarker.BYTES8, invalid, PackstreamBuf::readBytes8)));
  }
                ...
                dynamicTest(
                    ...
                    () -> {
                      ...
                      var buf =
                          prepareBuffer(
                              b ->
                                  b.writeByte(TypeMarker.TINY_STRING.getValue() ^ size)
                ...
                dynamicTest(
                    ...
                    () -> {
                      ...
                      var buf =
                          prepareBuffer(
                              b ->
                                  b.writeByte(TypeMarker.STRING8.getValue())
                                      .writeByte(size)
                                      .writeBytes(payload.getBytes(StandardCharsets.UTF_8)));
                ...
                dynamicTest(
                    ...
                    () -> {
                      ...
                      var buf =
                          prepareBuffer(
                              b ->
                                  b.writeByte(TypeMarker.STRING16.getValue())
                                      .writeShort(size)
                                      .writeBytes(payload.getBytes(StandardCharsets.UTF_8)));
                ...
                dynamicTest(
                    ...
                    () -> {
                      ...
                      var buf =
                          prepareBuffer(
                              b ->
                                  b.writeByte(TypeMarker.STRING32.getValue())
                                      .writeInt(size)
                                      .writeBytes(payload.getBytes(StandardCharsets.UTF_8)));
            ...
            size ->
                dynamicTest(
                    ...
                    () -> {
                      ...
                      var buf =
                          prepareBuffer(b -> b.writeByte(TypeMarker.TINY_LIST.getValue() ^ size));
                ...
                dynamicTest(
                    ...
                    () ->
                        assertThrowsUnexpectedTypeMarker(
                            TypeMarker.TINY_MAP,
                            invalid,
                            buf -> buf.readTinyMap(mock(Reader.class)))));
  }
                ...
                dynamicTest(
                    ...
                    () -> {
                      var buf =
                          prepareBuffer(
                              b ->
                                  b.writeByte(TypeMarker.TINY_STRUCT.getValue() ^ size)
                                      .writeByte(0x42));
        ...
        .map(
            invalid ->
                dynamicTest(
                    ...
                    () ->
                        assertThrowsUnexpectedType(
                            Type.STRUCT, invalid, PackstreamBuf::readStructHeader)));
  }
            ...
            size ->
                dynamicTest(
                    ...
                    () -> {
                      ...
                      when(registry.getReader(headerCaptor.capture()))
                ...
                dynamicTest(
                    ...
                    () ->
                        assertThrowsUnexpectedType(
                            Type.STRUCT,
                            invalid,
                            buf -> buf.readStruct(null, mock(StructRegistry.class)))));
  }
  ...
  void readStructShouldFailWithUnexpectedStruct() {
    var registry = mock(StructRegistry.class);
    var buf = prepareBuffer(b -> b.writeByte(TypeMarker.TINY_STRUCT.getValue()).writeByte(0x42));
  ...
  void readStructShouldRethrow() throws PackstreamReaderException {
    ...
    when(reader.read(isNull(), eq(buf), any()))
        .thenThrow(new PackstreamReaderException("Test Exception"));
