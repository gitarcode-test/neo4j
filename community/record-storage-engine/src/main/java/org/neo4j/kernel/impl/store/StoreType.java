...
public enum StoreType {
  ...
  PROPERTY_KEY_TOKEN_NAME(
      RecordDatabaseFile.PROPERTY_KEY_TOKEN_NAMES_STORE, RecordIdType.PROPERTY_KEY_TOKEN_NAME) {
    @Override
    public CommonAbstractStore open(NeoStores neoStores) {
  ...
  RELATIONSHIP_TYPE_TOKEN(
      RecordDatabaseFile.RELATIONSHIP_TYPE_TOKEN_STORE, SchemaIdType.RELATIONSHIP_TYPE_TOKEN) {
    @Override
    public CommonAbstractStore open(NeoStores neoStores) {
  ...
  META_DATA(
      RecordDatabaseFile.METADATA_STORE, RecordIdType.NODE) // Make sure this META store is last
  {
    @Override
    public CommonAbstractStore open(NeoStores neoStores) {
   ...
   * @return an {@link Optional} that wraps the matching store type of the specified file, or {@link
   *     Optional#empty()} if the given file name does not match any store files.
   */
